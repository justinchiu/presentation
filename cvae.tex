...
\item Uses a sequence of words as the latent representation $z$ in a VAE
\item Builds on \cite{kingma2014}, using M1 (the unsupervised VAE)
        and M2 (the semisupervised version)
\end{itemize}
\end{frame}
